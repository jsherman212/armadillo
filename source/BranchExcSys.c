...
char *DisassemblePSTATEInstr(struct instruction *instruction){
    ...
    unsigned int op2 = getbitsinrange(instruction->opcode, 5, 3);
    unsigned int CRm = getbitsinrange(instruction->opcode, 8, 4);
    unsigned int op1 = getbitsinrange(instruction->opcode, 16, 3);
...
char *DisassembleSystemInstr(struct instruction *instruction){
    ...
    unsigned int op2 = getbitsinrange(instruction->opcode, 5, 3);
    unsigned int CRm = getbitsinrange(instruction->opcode, 8, 4);
    unsigned int CRn = getbitsinrange(instruction->opcode, 12, 4);
    unsigned int op1 = getbitsinrange(instruction->opcode, 16, 3);
...
char *DisassembleSystemRegisterMoveInstr(struct instruction *instruction){
    ...
    unsigned int CRn = getbitsinrange(instruction->opcode, 12, 4);
    unsigned int op1 = getbitsinrange(instruction->opcode, 16, 3);
    unsigned int o0 = getbitsinrange(instruction->opcode, 19, 1);
    unsigned int L = getbitsinrange(instruction->opcode, 21, 1);
